...
No markdown fences, no explanation — raw JSON only.`;
    ...
    // Optionally save tasks to the board
    if (boardId) {
    ...
    // Return fallback tasks if OpenAI fails
    const fallback = [
...
Return a JSON object describing the diagram:
{
  ...
  "nodes": [{"id":"n1","label":"...","shape":"rect|circle|diamond","color":"#hexcolor","x":0,"y":0}],
  "edges": [{"from":"n1","to":"n2","label":""}]
}
Keep it to 4–7 nodes. No markdown, raw JSON only.`;
